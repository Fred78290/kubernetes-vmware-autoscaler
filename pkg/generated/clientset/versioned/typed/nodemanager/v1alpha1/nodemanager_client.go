...
import (
	...
	"github.com/Fred78290/kubernetes-vmware-autoscaler/pkg/generated/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type NodemanagerV1alpha1Interface interface {
...
// NewForConfigAndClient creates a new NodemanagerV1alpha1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*NodemanagerV1alpha1Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
	...
	return &NodemanagerV1alpha1Client{client}, nil
}

// NewForConfigOrDie creates a new NodemanagerV1alpha1Client for the given config and
...
func New(c rest.Interface) *NodemanagerV1alpha1Client {
	return &NodemanagerV1alpha1Client{c}
}
